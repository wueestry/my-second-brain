---
{"publish":true,"title":"Robotic Operating System","created":"2025-02-18 13:45","tags":["#cpp","#python","#resource","#robotics","#term"],"cssclasses":""}
---
...
> [!abstract]
> ROS is a set of software libraries and tools that help to build robot applications, providing frameworks for all aspects of robot development.
...
- **ROS 2** enhances support for microcontrollers and embedded systems, expanding its use in resource-constrained
  environments.
