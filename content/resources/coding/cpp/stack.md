---
{"publish":true,"title":"Stack","created":"2025-06-04","tags":["#coding","#computer-science","#cpp","#resource"],"cssclasses":""}
---
...
> [!abstract]
> A stack stores multiple elements in a specific order, called *LIFO* (Last In, First Out)
...
## Remove Elements
An element can be removed with `.pop()` from the stack. This will remove the *last* element added.
