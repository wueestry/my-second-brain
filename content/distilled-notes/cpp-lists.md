---
{"publish":true,"title":"Lists in C++","created":"2025-06-04 11:24","modified":"2025-10-01T21:17:17.306+02:00","tags":["#cpp","#data-structures","#programming","#lists","#cpp-lists","#stl","#data-types"],"cssclasses":"center-images"}
---
...
A **list** is similar to a [[vectors\|vector]] in that it can store multiple elements of the same type and dynamically grow in size.
...
The `.empty()` function returns `1` (_true_) if the list is empty and `0` (_false_) otherwise
